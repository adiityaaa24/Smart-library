          ...
          <div className="col-md-8 mx-auto">
            <div className="mb-4 text-center">
              <h4 className="fw-semibold mb-1">
                <i className="fa-solid fa-layer-group text-primary"></i>Add Category</h4>
              <p className='text-muted small'>
                Create new book catogories and manage their active status
              </p>
            </div>
          </div>
        </div>
              ...
              <div className='card border-0 shadow-sm rounded-4'>
                <div className='card-body p-4'>
                  ...
                  {categories.length === 0 ? (
                    ...
                    <p className='text-muted small'>No Categories found. Add your first category from the form.</p>
