#serializers = django model ko json me convert
#deserializer = json ko django model me convert
...
class BookListSerializer(serializers.ModelSerializer):
    author_name = serializers.CharField(source="author.name", read_only=True)
    category_name = serializers.CharField(source="category.name", read_only=True)
    available_quantity = serializers.SerializerMethodField()  #new field to show available quantity
    class Meta:
        model = Book
...
class IssuedBookSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = IssuedBook
        fields = ["id", "book", "book_title", "book_isbn", "book_cover", "student", "student_id", "student_name", 
        "issued_at", "returned_at", "is_returned", "fine", "remark",  "created_at", "updated_at"]